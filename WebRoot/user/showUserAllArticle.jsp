					...
					<tr>
						<td>
							<table width="1000" cellpadding="6" cellspacing="1"
								...
								<s:iterator value="#request.all" id="art">
									<tr>
										<td bgcolor="#FFFFFF"><font class="chinesefont105main">
												<!-- 文章标题  --> <a
												href="showArticle.action?id=<s:property value='#art.id'/>"><s:property
														value="#art.title" /></a>
												...
												<div align='right' class='smalltxt' height='32px'>
													...
													<!-- 评论与点击数 -->
													|评论(
													<s:property value='#request.critiqueCounts[#art.id]' />
													)|点击(
								...
								<tr>
									<td align="center"><s:if test="#request.page.hasPrePage">
											...
											<a
												href="showUserAllArticle.action?currentPage=${page.totalPage}">尾页</a>
										</s:if> <s:else>
												下一页
												尾页
											</s:else></td>
