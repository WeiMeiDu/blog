								...
								<tr>
									<td>
										<table width="1000" cellpadding="6" cellspacing="1"
											...
											<s:iterator value="#request.allCri" id="cri">
												...
												<tr>
													<td bgcolor="#FFFFFF">
														<p align="right">
															<s:property value="#loushu" />
															楼
														</p> <font class="chinesefont105main"> <s:property
																value="#cri.content" escape="false" />
															<hr size='1' noshade color='#CCCCCC'> <br>
															<p align="right">
																<!-- 发表时间 -->
																发表于:
											...
											<tr>
												<td align="center"><s:if
														test="#request.page.hasPrePage">
														<a href="showArticle.action?currentPage=1">首页</a>
														<a
															href="showArticle.action?currentPage=${page.currentPage-1}">上一页</a>
													</s:if> <s:else>
												首页
												上一页
											</s:else> <s:if test="#request.page.hasNextPage">
														<a
															href="showArticle.action?currentPage=${page.currentPage+1}">下一页</a>
														<a href="showArticle.action?currentPage=${page.totalPage}">尾页</a>
													</s:if> <s:else>
												下一页
												尾页
											</s:else></td>
										...
										<form action="addCritique.action" method="post">
											...
											<TABLE WIDTH="1000" height="300" BORDER="0" CELLPADDING="0"
												...
												<TR>
													...
													<TD COLSPAN="2" align="center" valign="top">
														<table width="1000"
															...
															<tr height="30">
																<td background="image/l-bg3.jpg">&nbsp;&nbsp;&nbsp;<font
																	color="#ffff66"><b>评论</b></font></td>
															</tr>
															<tr>
																<td>&nbsp;&nbsp;&nbsp;内容： <FCK:editor
																		instanceName="content" basePath="/user/fckeditor"
																		toolbarSet="myToolbar" height="200"></FCK:editor>
																</td>
															</tr>
															<tr height="20">
																<td><input type="submit" value="添加"
																	Style="ButtonCss" /> <input type="button"
																	name="cancelButton" value="取消" onClick="history.back()"
																	Class="ButtonCss"></td>
															</tr>
														</table>
													</TD>
