...
<body topmargin="0" leftmargin="0" bgcolor="#f3f3f3">
		...
		<%--Register action中validate方法用到this.addActionError("用户名不能为空"); 
		 则在jsp页面添加<s:actionerror /> --%>
		<form id="Form1" action="register.action" method="post" >
			<table width="1000" cellpadding="0" cellspacing="0" border="0" style="margin: auto">
				<tr height="100">
					<td colspan="2">&nbsp;</td>
				</tr>
				<tr>
					...
					<td width="20">&nbsp;</td>
					<td valign="top">
						<table width="500" border="0" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF;BORDER-RIGHT:#cccccc 1px solid; BORDER-TOP:#cccccc 1px solid; BORDER-LEFT:#cccccc 1px solid; BORDER-BOTTOM:#cccccc 1px solid; BORDER-COLLAPSE:collapse">
							<tr height="30">
