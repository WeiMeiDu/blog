...
<body onLoad="document.forms[0]['username'].focus()" topmargin="0"
	...
	<form id="Form1" action="login.action" method="post" >
		<table width="1000" cellpadding="0" cellspacing="0" border="0" style="margin: auto">
			...
			<tr>
				<td width="200">&nbsp;</td>
				<td width="420" align="center" valign="bottom"><table
						width="360" border="1" cellpadding="0" cellspacing="0"
						...
						<tr height="30">
							<td colspan="2" align="center" background="image/main/l-bg1.jpg"><span
								class="STYLE1">博客登录</span></td>
						</tr>
						<tr height="30">
						...
						<tr height="40">
							<td><input type="submit" id="loginButton" value="登录"
								style="buttoncss"></td>
						</tr>
					</table></td>
